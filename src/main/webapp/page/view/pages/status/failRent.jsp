...
<div class="alert alert-warning" role="alert">
    ...
    <p>Sorry, when you read this message. You hava failed to Rent the House.</p>
    <p>Because You Don't Have Enough Money! Please Recharge and Try Later!</p>
    <hr>
    <p class="mb-0"></p>
    <a href="<c:url value="/page/view/pages/user/rentManagerList"/>" class="alert-link">点击这里返回</a>
