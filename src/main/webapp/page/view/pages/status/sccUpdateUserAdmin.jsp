...
<div class="alert alert-success" role="alert">
    ...
    <p>Aww yeah, when you read this message. You hava successfully Updated the UserInfo.</p>
    <hr>
    <p class="mb-0"></p>
    <a href="<c:url value="/page/view/pages/admin/updateUser"/>" class="alert-link">点击这里返回</a>
